      ...
      <form action="{{route('admin.aboutUsAboutUs.details', $about_us_details->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="form-group">
              <label>Address</label>
                <textarea class="textarea_editor form-control" name="address" rows="4" placeholder="Enter text ..." readonly="">{!! $about_us_details->address !!}</textarea>
            </div>
          </div>
          <div class="col-md-8">
            <div class="form-group">
                  <div class="card-body">
                      ...
                      <div class="form-group">
                          <textarea class="textarea_editor form-control" name="describtion" rows="6" placeholder="Enter text ..." readonly="">{!! $about_us_details->describtion !!}</textarea>
                      </div>
                  </div>
              </div>
          </div>
