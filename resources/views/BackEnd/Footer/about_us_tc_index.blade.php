        ...
        <div class="sparkline13-list" style="margin-top: -60px;">
            ...
            <div class="sparkline13-graph">
                <div class="datatable-dashv1-list custom-datatable-overright">
                    <div id="toolbar">
                       <a href="{{route('admin.aboutUsTandC.create')}}" class="btn btn-info" role="button">Create</a>
                    </div>
                    <table  id="table" data-toggle="table" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
                        ...
                        <tbody>
                            ...
                            <tr>      
                                ...
                                <td><a href="{{route('admin.aboutUsTandC.details',$all_describtions->id)}}" class="btn btn-warning" role="button"> Click Here For Details</a></td>
                                <td>
                                    <a href="{{route('admin.aboutUsTandCGetEdit',$all_describtions->id)}}" class="btn btn-primary" role="button">Edit</a>
		                        ...
		                        <div class="modal fade" id="exampleModal_{{$all_describtions->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		                              <div class="modal-dialog" role="document">
		                                <div class="modal-content">
		                                  ...
		                                  <form action="{{route('admin.aboutUsTandC.delete',$all_describtions->id)}}" method="post"> 
		                                    @csrf
